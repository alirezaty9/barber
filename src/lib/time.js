// کمکی‌های تاریخِ مستقل از تایم‌زونِ سرور. عمداً هیچ‌جا به ساعتِ محلیِ سرور تکیه نمی‌کنیم،
// چون تایم‌زونِ سرور از هاستی به هاستِ دیگر فرق می‌کند (UTC، تهران، …) و اگر کد به آن
// وابسته باشد، با یک جابه‌جاییِ هاست، تاریخِ نوبت‌ها یک روز جابه‌جا می‌شود.

...
// را آزاد نشان داده بود. کرونِ expire-pending این رکوردها را جارو می‌کند ولی هر ۲ ساعت یک‌بار
// (رجوع به آرایه‌ی cron در liara.json)، پس بینِ دو اجرا اسلات می‌توانست قفل بماند. اینجا همان
// لحظه و اتمیک آزادش می‌کنیم — یعنی مشتری هیچ‌وقت منتظرِ کرون نمی‌ماند و کرون فقط نقشِ
// نظافتچیِ رکوردهای کهنه را دارد، نه نقشِ آزادکننده‌ی اسلات.

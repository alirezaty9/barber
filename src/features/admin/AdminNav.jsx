...
import { ShieldCheck, LogOut, LayoutDashboard, CalendarDays, PlusCircle, Settings2, Home } from 'lucide-react';
...
const TABS = [
  ...
  { href: '/admin/manage', label: 'خدمات و آرایشگران', icon: Settings2 },
];
